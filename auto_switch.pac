var FindProxyForURL = function(init, profiles) {
    ...
    "+auto switch": function(url, host, scheme) {
        ...
        if (/(?:^|\.)nudegirls4u\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)tumblr\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)cedexis-test\.com$/.test(host)) return "+proxy";
        ...
        if (/(?:^|\.)adultblogtoplist\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)gravuresidol\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)zolo86\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)dartlang\.org$/.test(host)) return "+proxy";
        if (/(?:^|\.)flutter\.io$/.test(host)) return "+proxy";
        ...
        if (/(?:^|\.)cdnjav\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)oltracking\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)oload\.stream$/.test(host)) return "+proxy";
        if (/(?:^|\.)openload\.co$/.test(host)) return "+proxy";
        if (/(?:^|\.)eee326\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)facebook\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)google-analytics\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)fir\.sh$/.test(host)) return "+proxy";
        if (/(?:^|\.)hmcczsoimnjxzi\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)kvcymnoxr\.com$/.test(host)) return "+proxy";
        ...
        if (/(?:^|\.)girlsofdesire\.org$/.test(host)) return "+proxy";
        if (/(?:^|\.)lorempixel\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)jshell\.net$/.test(host)) return "+proxy";
        if (/(?:^|\.)billboard\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)581gg\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)sinaimg\.cn$/.test(host)) return "+proxy";
        if (/(?:^|\.)ttt669\.com$/.test(host)) return "+proxy";
        ...
        if (/(?:^|\.)adminlte\.io$/.test(host)) return "+proxy";
        if (/(?:^|\.)sublimetext\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)panjiachen\.github\.io$/.test(host)) return "+proxy";
        if (/(?:^|\.)airpr\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)demdex\.net$/.test(host)) return "+proxy";
        if (/(?:^|\.)adobe\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)peachring\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)clickme\.net$/.test(host)) return "+proxy";
        if (/(?:^|\.)surmon-china\.github\.io$/.test(host)) return "+proxy";
        if (/(?:^|\.)codepen\.io$/.test(host)) return "+proxy";
        if (/(?:^|\.)nintendo\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)packagist\.org$/.test(host)) return "+proxy";
        if (/(?:^|\.)xmind\.net$/.test(host)) return "+proxy";
        if (/(?:^|\.)jsfiddle\.net$/.test(host)) return "+proxy";
        if (/(?:^|\.)dzf283eh31vp4\.cloudfront\.net$/.test(host)) return "+proxy";
        if (/(?:^|\.)mozilla\.net$/.test(host)) return "+proxy";
        if (/(?:^|\.)highwebmedia\.com$/.test(host)) return "DIRECT";
