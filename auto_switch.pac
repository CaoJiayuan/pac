var FindProxyForURL = function(init, profiles) {
    ...
    "+auto switch": function(url, host, scheme) {
        "use strict";
        if (/(?:^|\.)omniconvert\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)dashlane\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)allmacwallpaper\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)lavame\.info$/.test(host)) return "+proxy";
        if (/(?:^|\.)pictures\.com$/.test(host)) return "+proxy";
        if (/^174\.127\.195\.163$/.test(host)) return "+proxy";
        if (/(?:^|\.)qpix\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)msnbbs\.me$/.test(host)) return "+proxy";
        if (/(?:^|\.)naishui8\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)thegravureidols\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)moonhug\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)zolo86\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)chaselachance\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)maomiav\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)girlimg\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)sexygirlsz\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)forwallpaper\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)imilfs\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)naughtyamerica4k\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)tiny4k\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)fbcdn\.net$/.test(host)) return "+proxy";
        if (/(?:^|\.)playboytubes\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)uphentaivid\.net$/.test(host)) return "+proxy";
        if (/(?:^|\.)51\.la$/.test(host)) return "+proxy";
        if (/(?:^|\.)jinniumovie\.be$/.test(host)) return "+proxy";
        if (/(?:^|\.)fonts\.googleapis\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)steampowered\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)eronuki\.net$/.test(host)) return "+proxy";
        if (/(?:^|\.)php\.net$/.test(host)) return "+proxy";
        if (/(?:^|\.)brazzers-girls\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)torrentkittyjx\.org$/.test(host)) return "+proxy";
        if (/(?:^|\.)googlevideo\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)laracasts\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)pexels\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)slideshare\.net$/.test(host)) return "+proxy";
        if (/(?:^|\.)logitech\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)discourse\.org$/.test(host)) return "+proxy";
        if (/(?:^|\.)pornhub\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)docker\.io$/.test(host)) return "+proxy";
        if (/(?:^|\.)s3\.amazonaws\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)perl\.org$/.test(host)) return "+proxy";
        if (/(?:^|\.)pimg\.net$/.test(host)) return "+proxy";
        if (/(?:^|\.)alpinelinux\.org$/.test(host)) return "+proxy";
        if (/(?:^|\.)perimeterx\.net$/.test(host)) return "+proxy";
        if (/(?:^|\.)docker\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)drivereasy\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)virtualbox\.org$/.test(host)) return "+proxy";
        if (/(?:^|\.)urlpic\.club$/.test(host)) return "+proxy";
        if (/(?:^|\.)allgravure\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)bp\.blogspot\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)577gc\.org$/.test(host)) return "+proxy";
        if (/(?:^|\.)wixsite\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)mycamgirl\.net$/.test(host)) return "+proxy";
        if (/(?:^|\.)mymoviecinema\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)3dxchat\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)roy12mods\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)amazon\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)softaculous\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)bootstrapcdn\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)movie4u\.cc$/.test(host)) return "+proxy";
        if (/(?:^|\.)loverslab\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)deviantart\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)smart2pay\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)speedtest\.net$/.test(host)) return "+proxy";
        if (/(?:^|\.)porn69\.xyz$/.test(host)) return "+proxy";
        if (/(?:^|\.)tumblr\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)youtube\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)aclst\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)nurglesnymphs\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)pornstarblognetwork\.com$/.test(host)) return "+proxy";
        if (/^101\.110\.118\.25$/.test(host)) return "+proxy";
        if (/(?:^|\.)clubevakarera\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)porn96\.xyz$/.test(host)) return "+proxy";
        if (/(?:^|\.)apidocjs\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)facebook\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)bitbucket\.org$/.test(host)) return "+proxy";
        if (/(?:^|\.)ahcdn\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)tsyndicate\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)xhcdn\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)xhamsterlive\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)xhamster\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)xhamporn\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)gbatemp\.net$/.test(host)) return "+proxy";
        if (/(?:^|\.)nintendo\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)dmca\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)chaturbate\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)ajax\.googleapis\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)eurogamer\.net$/.test(host)) return "+proxy";
        if (/(?:^|\.)d301sr5gafysq2\.cloudfront\.net$/.test(host)) return "+proxy";
        if (/(?:^|\.)phpmyadmin\.net$/.test(host)) return "+proxy";
        if (/(?:^|\.)gstatic\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)ytimg\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)googleadservices\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)sennheiser-reshapingexcellence\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)languageisavirus\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)filesmonster\.org$/.test(host)) return "+proxy";
        ...
        if (/(?:^|\.)lillyroma\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)wnu\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)thebestvideocontentever\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)lubed\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)lanasbigboobs\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)netdna-ssl\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)rankedboost\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)spaceengine\.org$/.test(host)) return "+proxy";
        if (/(?:^|\.)pelpix\.info$/.test(host)) return "+proxy";
        if (/(?:^|\.)google\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)hdreporn\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)imgur\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)ddfstatic\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)99yp\.cc$/.test(host)) return "+proxy";
        if (/(?:^|\.)87lou\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)fancyte\.ch$/.test(host)) return "+proxy";
        if (/(?:^|\.)imagetu\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)piclect\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)dbr\.ee$/.test(host)) return "+proxy";
        if (/(?:^|\.)puu\.sh$/.test(host)) return "+proxy";
        if (/(?:^|\.)static-bluray\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)cvcer\.net$/.test(host)) return "+proxy";
        if (/(?:^|\.)tnmhl\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)51fls\.xyz$/.test(host)) return "+proxy";
        if (/(?:^|\.)fls51\.xyz$/.test(host)) return "+proxy";
        if (/(?:^|\.)brazzerscontent\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)sshnuke\.net$/.test(host)) return "+proxy";
        if (/(?:^|\.)fullpix\.net$/.test(host)) return "+proxy";
        if (/(?:^|\.)97luhi\.tienda$/.test(host)) return "+proxy";
        if (/(?:^|\.)1024xp\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)yelang2\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)zhaofanhaoba\.net$/.test(host)) return "+proxy";
        if (/(?:^|\.)wiiubrew\.org$/.test(host)) return "+proxy";
        if (/(?:^|\.)wiiuusbhelper\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)utorrent\.com$/.test(host)) return "+proxy";
        ...
        if (/(?:^|\.)everythingisaremix\.info$/.test(host)) return "+proxy";
        if (/(?:^|\.)squarespace\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)sensualgirls\.org$/.test(host)) return "+proxy";
        if (/(?:^|\.)highwebmedia\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)alijingjia\.cn$/.test(host)) return "+proxy";
        if (/(?:^|\.)google-analytics\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)zoedj\.co$/.test(host)) return "+proxy";
        if (/(?:^|\.)packagist\.org$/.test(host)) return "+proxy";
        if (/(?:^|\.)dbrand\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)porndoe\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)yadro\.ru$/.test(host)) return "+proxy";
        if (/(?:^|\.)ddfcams\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)nudity911\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)sexix\.net$/.test(host)) return "+proxy";
        if (/(?:^|\.)dffnetwork\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)reality-girls\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)cemu\.info$/.test(host)) return "+proxy";
        if (/(?:^|\.)xx110\.info$/.test(host)) return "+proxy";
        if (/(?:^|\.)yelang1\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)pinupfiles\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)sliver\.tv$/.test(host)) return "+proxy";
        if (/(?:^|\.)ungrounded\.net$/.test(host)) return "+proxy";
        if (/(?:^|\.)newgrounds\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)comdotcdn\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)comdotgame\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)oboom\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)depositfiles\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)datafile\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)uploaded\.net$/.test(host)) return "+proxy";
        if (/(?:^|\.)pixxxels\.org$/.test(host)) return "+proxy";
        if (/(?:^|\.)naughtymachinima\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)xn--i2ru8q2qg\.com$/.test(host)) return "DIRECT";
        if (/(?:^|\.)phncdn\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)hentaiplay\.net$/.test(host)) return "+proxy";
        if (/(?:^|\.)jwplatform\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)hentaiplanet\.info$/.test(host)) return "+proxy";
        if (/(?:^|\.)chatango\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)exoclick\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)juicyads\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)iwara\.tv$/.test(host)) return "+proxy";
        if (/(?:^|\.)hongfire\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)mega\.nz$/.test(host)) return "+proxy";
        if (/(?:^|\.)mega\.co\.nz$/.test(host)) return "+proxy";
        if (/(?:^|\.)gamevixenzone\.net$/.test(host)) return "+proxy";
        if (/(?:^|\.)bladeandsouldojo\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)nexusmods\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)undertow\.club$/.test(host)) return "+proxy";
        if (/(?:^|\.)etahub\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)futanaridickgirls\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)777kl\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)opengl\.org$/.test(host)) return "+proxy";
        if (/(?:^|\.)maika520\.com$/.test(host)) return "DIRECT";
        if (/(?:^|\.)zhaichong\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)mycard520\.com\.tw$/.test(host)) return "+proxy";
        if (/(?:^|\.)pearlcdn\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)klyou\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)blackdesert\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)blackdesert\.com\.tw$/.test(host)) return "+proxy";
        if (/(?:^|\.)origin\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)clienttolocalhostonly\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)optimizely\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)ea\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)sourceforge\.net$/.test(host)) return "+proxy";
        if (/(?:^|\.)cygwin\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)jetbrains\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)581gg\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)pussysaga\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)erotica7\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)hh458\.net$/.test(host)) return "+proxy";
        if (/(?:^|\.)37dutiwen\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)edgecastdns\.net$/.test(host)) return "+proxy";
        if (/(?:^|\.)56avs\.us$/.test(host)) return "+proxy";
        if (/(?:^|\.)lulmei\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)woaimm\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)8884c\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)ranchat\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)japanesetube\.net$/.test(host)) return "+proxy";
        if (/(?:^|\.)hqasianxxx\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)oloadcdn\.net$/.test(host)) return "+proxy";
        if (/(?:^|\.)videomega\.tv$/.test(host)) return "+proxy";
        if (/(?:^|\.)addthis\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)javseeds\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)tubehentai\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)adult-eromovies\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)webstarts\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)linksynergy\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)deviantart\.net$/.test(host)) return "+proxy";
        if (/(?:^|\.)liadm\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)load\.s3\.amazonaws\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)affect3d\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)3dpornlinks\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)qixiwl\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)yeseav\.cc$/.test(host)) return "+proxy";
        if (/(?:^|\.)dix3\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)oxox616\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)yandex\.ru$/.test(host)) return "+proxy";
        if (/(?:^|\.)girl-atlas\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)erog\.fr$/.test(host)) return "+proxy";
        if (/(?:^|\.)asiaxxxporn\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)twitter\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)pinterest\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)getpocket\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)gravuregirlz\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)mmdm\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)myfreecams\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)wp\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)zentora\.net$/.test(host)) return "+proxy";
        if (/(?:^|\.)sexychinese\.net$/.test(host)) return "+proxy";
        if (/(?:^|\.)git-scm\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)videocopilot\.net$/.test(host)) return "+proxy";
        if (/(?:^|\.)adobe\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)adobeoobe\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)adobelogin\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)typekit\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)typekit\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)github-cloud\.s3\.amazonaws\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)black\.gdn\.gamecdn\.net$/.test(host)) return "+proxy";
    ...
    "+__ruleListOf_auto switch": function(url, host, scheme) {
        ...
        if (/(?:^|\.)findmima\.com$/.test(host)) return "+proxy";
        ...
        if (/^https:\/\/github\.com\/programthink\/zhao/.test(url)) return "+proxy";
        ...
        if (/(?:^|\.)googlecapital\.com$/.test(host)) return "+proxy";
        ...
        if (scheme === "http" && url.indexOf(".enanyang.my/news/20170502/%E7%BE%8E%E5%9B%BD%E4%B9%8B%E9%9F%B3%E5%A4%A7%E5%9C%B0%E9%9C%87%E3%80%8A%E8%8B%B9%E6%9E%9C%E3%80%8B%E7%8B%AC%E5%AE%B6") >= 0) return "+proxy";
        ...
        if (/(?:^|\.)a1\.nyt\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)int\.nyt\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)s1\.nyt\.com$/.test(host)) return "+proxy";
        if (scheme === "http" && url.indexOf("static01.nyt.com") >= 0) return "+proxy";
        if (/(?:^|\.)static01\.nyt\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)typeface\.nyt\.com$/.test(host)) return "+proxy";
